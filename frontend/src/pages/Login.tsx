...
const Login = () => {
   ...
   return (
      <div className="min-h-screen bg-cyber-black flex items-center justify-center p-4 relative overflow-hidden">
         <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,242,255,0.05)_0%,transparent_70%)] pointer-events-none"></div>
         ...
         <div className="w-full max-w-lg glass-morphism p-12 rounded-3xl border border-white/10 relative z-10">
            <div className="text-center mb-8">
               <div className="inline-flex bg-cyber-blue/10 p-3 rounded-2xl mb-4">
            ...
            <p className="text-center text-gray-500 text-sm mt-8">
               Don't have an account? <Link to="/signup" className="text-cyber-blue hover:text-white transition-colors font-bold">Sign Up</Link>
            </p>
         </div>
      </div>
   );
